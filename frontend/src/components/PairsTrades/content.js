...
export const aboutPairsTradesContent = {
  ...
  structurePairsTrades:
    "It is very important to already have a view on macro-economic conditions when composing a trade. It is also important to now how volatile in terms of price movement are assets we want to include in our trade. Also we should include technical analysis of the price charts as a tool to choose the moment of entering the trade.",
};

export const ratioChartContent = {
  description:
    "Ratio chart shows how ratio beetwen long price and short price has moved over the time. Stock that is bought should always be in nominator, stock sold should always be in denominator. It should be analyzed like every other price chart, using techincal analysis. Chart below shows data from the last year (250 trading days)",
};
